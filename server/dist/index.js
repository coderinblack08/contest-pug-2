...
const ContestResolver_1 = require("./resolvers/ContestResolver");
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const apolloServer = new apollo_server_express_1.ApolloServer({
        schema: yield type_graphql_1.buildSchema({
            resolvers: [HelloResolver_1.HelloResolver, UserResolver_1.UserResolver, ContestResolver_1.ContestResolver],
            validate: false,
        }),
